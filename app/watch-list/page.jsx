            ...
            <div className='container mx-auto p-6 sm:p-12'>
                <div className='flex justify-between items-start'>
                    ...
                    <form action="/auth/signout" method='post'>
                        <button type='submit' className='bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-3'>Sign Out</button>
                    </form>
                </div>
                <WatchForm />
                <div className='mt-6'>
                            ...
                            <div key={watch.id} className='mb-4 p-4 bg-gray-800 rounded-lg shadow'>
                                ...
                                <div className='flex space-x-2'>
                                    <form action={deleteWatch}>
                                        ...
                                        <button type='submit' className='bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-3 rounded-md'>Delete</button>
                                    </form>
